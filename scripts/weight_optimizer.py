...
def main() -> int:
    ...
    parser.add_argument(
        "--baseline-weights",
        default=None,
        help="Comma-separated 20 values used only when --baseline-cmd is omitted",
    )
    parser.add_argument(
        "--init-weights",
        default=None,
        help="Comma-separated 20 values to start optimization from (default: built-in defaults)",
    )
